...
void koboImaginaryChess(int baris, int kolom, int size, int *papan) {
  ...
  for (int i = 0; i < size; i++) {
    ...
    if (kemungkinanX >= 0 && kemungkinanX < size && kemungkinanY >= 0 && kemungkinanY < size) {
